    ...
    <div class="navigation">
        ...
        <div class="section-inner">
            ...
            <ul class="main-menu">
                ...
                <li><a class="socialmedia" href="https://web.facebook.com/pysznytortpl-1539476059712969/"><img src="http://localhost/wordpress/wp-content/uploads/2018/11/logofb.png" height="15px" width="15px"></a></li>
                ...
                <li class="header-search">
                    <form method="get" class="search-form" id="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                        ...
                        <a class="search-button" onclick="document.getElementById( 'search-form' ).submit(); return false;">
    ...
    <div class="header section-inner">
        ...
        <h<?php echo $title_type; ?> class="blog-title">
            <a href="<?php echo esc_url( home_url() ); ?>" title="<?php echo esc_attr( get_bloginfo( 'title' ) ); ?> &mdash; <?php echo esc_attr( get_bloginfo( 'description' ) ); ?>" rel="home">
                <?php echo esc_attr( get_bloginfo( 'title' ) ); ?></a>
