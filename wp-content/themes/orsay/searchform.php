...
<form role="search" method="get" class="form-search" action="<?php echo esc_url( home_url( '/' ) ); ?>">
  ...
  <div class="input-group">
  	...
  	<label class="screen-reader-text" for="s"><?php esc_html_e( 'Search for:', 'orsay' ); ?></label>
    <input type="text" class="form-control search-query" placeholder="<?php echo esc_attr_x( 'Search & Help', 'placeholder', 'orsay' ); ?>" value="<?php the_search_query(); ?>" name="s" title="<?php echo esc_attr_x( 'Search for:', 'label', 'orsay' ); ?>" />
